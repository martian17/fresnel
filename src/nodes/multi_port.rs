// We currently have no plans for implementing this file
// The mathematics is sound; my paper defines a scatter matrix representation for
// n by n compoentns, and generalized multi qudit error channel representation
// pushed down to future sprints
